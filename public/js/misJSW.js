                ...
                function CenterControl(controlDiv, map) {
                    ...
                    controlUI.addEventListener('click', function() {             
                        $.get('cargarMarkers', function(data){
                            ...
                            var infowindow;
                            $('#listadoEventos').html("");
                            $('#listadoEventos').append($("<table>").attr("class","tablaListado"));
                            $('#listadoEventos').append($("<tr>").attr("style","background-color: #f2f2f2;"));
                            ...
                            data.forEach(d => {
                                ...
                                marcadorTemp.addListener('click', function() {
                                    infowindow = new google.maps.InfoWindow({
                                        content: "<b>Descripción:</b>" + " " + d.descripcion + "<br>" +
                                        "<b>Denunciante:</b> " + " "+ d.Nombre + " " + d.Apellido + " " + " " + d.DNI + "<br>" +
                                        "<b>Coordenadas:</b> " + " " + d.latitud + " " + d.longitud + "<br>" +
                                        "<b>Tipo:</b>" + " " + d.tipoEvento + "<br>"
                                    });
          ...
          //  }
            ...
            function registrarDetalle(obj) {
                ...
                var infowindow = new google.maps.InfoWindow({
                    content: "<b>Descripción:</b>" + " " + descripcion + "<br>" +
                    "<b>Denunciante:</b> " + " "+ Nombre + " " + Apellido + " " + " " + DNI + "<br>" +
                    "<b>Coordenadas:</b> " + " " + latitud + " " + longitud + "<br>" +
                    "<b>Tipo:</b>" + " " + tipo + "<br>"                
                  });
            ...
            function eliminar(obj){
                var r = confirm("¿Seguro que desea eliminar el evento?");
                if (r == true) {
